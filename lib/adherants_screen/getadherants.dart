...
class getAllAdherants extends State<getadherants>{
  var adherants = List<AdherantsModel>.generate(200, (index) => null!);

  Future <List<AdherantsModel>> getadherants () async{
    final data = await http.get(Uri.parse('http://localhost:8088/api/v1/users/findUserDto'));
    var jsonData = json.decode(data.body);

    List<AdherantsModel> adherant =[];
